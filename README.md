...
该比赛的任务是根据app的描述信息进行app分类，典型的文本分类问题。此仓库提供了我参加比赛的解决方法，主要是一系列用于文本分类的深度学习模型，如 **FastText**, **TextCNN**, **TextRNN**, **TextBiRNN**, **TextAttBiRNN**, **HAN**, **RCNN**, **RCNNVariant** 等。在这些基础模型之上，利用Stack框架进行集成学习。
